...
# +Scenario 0. Classification ( Binary {sigmoid} )
Scenario_0_Train_Req = \
"""
{
  "id": "classification-model-00",
  "data": {
      "X": {
          "source": [
...
"""
print( requests.post( "http://"+API_SERVER_IP+":"+str(API_SERVER_PORT)+Deep_Learning_Train_Path, data=json.dumps(Scenario_0_Train_Req)).content )
'''
    would be outputing this
    ->
    b'{"status":true,"output":[ ... ,{"accuracy":0.6666666865348816,"loss":0.7079260349273682,"val_accuracy":0.5,"val_loss":0.6534299254417419},{"accuracy":0.6666666865348816,"loss":0.705938994884491,"val_accuracy":0.5,"val_loss":0.6639962196350098}]}'
'''

print( requests.post( "http://"+API_SERVER_IP+":"+str(API_SERVER_PORT)+Deep_Learning_Prediction_Path, data=json.dumps(Scenario_0_Prediction_Req)).content )
'''
    would be outputing this
    ->
    b'{"status":true,"output":{"argmax":{"A":0.5155690908432007},"argmin":{"B":0.48443087935447693},"all":{"A":0.5155690908432007,"B":0.48443087935447693}}}'
'''


# Scenario 1. Classification ( Softmax )
...
"""
print( requests.post( "http://"+API_SERVER_IP+":"+str(API_SERVER_PORT)+WithId_Samples_Push_PATH, data=json.dumps(Scenario_1_Sample_Push)).content )